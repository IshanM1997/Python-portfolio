...
export class ProjectsComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    // Load projects from JSON (auto-generated by github_sync.py) with fallback
    this.svc.getProjects().subscribe(projects => {
      this.projects = projects;
      this.loadingProjects = false;
      setTimeout(() => this.updateArrows('projects'), 100);
    });
    this.certificates = this.svc.getCertificates();
  }

  ngAfterViewInit(): void {
    this.updateArrows('certs');
  }
